...
const ProductGrid: React.FC = () => {
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      {/* Filters */}
      <div className="flex flex-wrap items-center justify-between mb-8 p-4 bg-gradient-to-r from-yellow-50 to-red-50 rounded-xl border border-yellow-200/60 shadow-sm">
        {/* Categories */}
        ...
        <div className="flex items-center space-x-4">
          <select
            ...
            className="px-4 py-2 border border-gray-300 rounded-lg text-xs font-semibold focus:outline-none focus:ring-2 focus:ring-red-500"
          >
